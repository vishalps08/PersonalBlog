...
export default function PostCard({ post }) {
  return (
    <Link to={`/posts/${post.slug}`} className="group flex gap-5 py-6">
      <div className="flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded bg-ash/5">
        {post.coverImage?.url ? (
          <img
      ...
      <div className="min-w-0">
        ...
        <h2 className="font-display text-lg font-600 text-ink group-hover:text-safelight">
          {post.title}
        </h2>
